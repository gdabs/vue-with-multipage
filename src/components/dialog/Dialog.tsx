...
export default defineComponent({
  ...
  props: extend({}, popupSharedProps, {
    title: [String, Function] as PropType<DialogMessage>,
  ...
  setup(props, { emit, slots }) {
    ...
    const renderTitle = () => {
      const title = slots.title ? slots.title() : isFunction(props.title) ? props.title() : props.title;
      if (title) {
        return (
          <div
            class={bem('header', {
    ...
    return () => {
      ...
      return (
        <Popup
          role="dialog"
          class={[bem([theme]), props.className]}
